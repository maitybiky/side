...
const BASE_URL = "https://admin.iaasupport.com/api/user/";
const IMG_URL = "https://admin.iaasupport.com/";
...
async function requestData(url, method, params = {}) {
  ...
  // myHeaders.append("authorization", "4cyk99ps2bpb0q@2t*ev55lgldhs_*2+@$a0~0rn%wk~gsio!uqph0sp@%qdq^zpvrtfx~1m3re9d-f&$kkg35758wd3%2xdhrkhf5aiy_1vj~r9j4zrb+mp3nsr-#xzd$n!u6xa7n8%cnov3ns&j$");

  // myHeaders.append("userType", "Teacher");
  myHeaders.append("Content-Type", "application/json");
  myHeaders.append("Access-Control-Allow-Origin", "http://13.232.100.13:8003");
...
async function fileUplodeDynamic(
  ...
  let bash_url = "https://admin.iaasupport.com/api/user/";
  let apiUrl = bash_url + url;
  ...
  let headers = {
    ...
    "Access-Control-Allow-Origin": "http://13.232.100.13:8003",
...
async function newFileCropUpload(url, file, object_get) {
  let bash_url = "https://admin.iaasupport.com/";
  // let bash_url = "http://127.0.0.1:3030/api/";
...
async function uploadFileRequest(url, file, callback) {
  // const BASE_URL = "https://admin.iaasupport.com/";
